...
import com.rx.retrofit.download.listener.DownloadInterceptor;
import com.rx.retrofit.exception.HttpTimeException;
import com.rx.retrofit.exception.RetryWhenNetworkException;
import com.rx.retrofit.http.HttpManager;
import com.rx.retrofit.subscribers.ProgressDownSubscriber;
import com.rx.retrofit.utils.AppUtil;
import com.rx.retrofit.utils.DbDownUtil;
...
public class HttpDownManager {
    ...
    public static HttpDownManager getInstance(){
        if (INSTANCE==null)
            ...
            if (INSTANCE ==  null) INSTANCE = new HttpDownManager();
        }
        return INSTANCE;
    }
